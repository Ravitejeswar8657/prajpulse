...
REPRESENTATIVES = {
    "srikakulam": {
        "mps": [{"name": "Kinjarapu Ram Mohan Naidu", "party": "TDP", "constituency": "Srikakulam"}],
        "mlas": [
            {"name": "Ashok Bendalam", "party": "TDP", "constituency": "Ichchapuram"},
            {"name": "Gouthu Sireesha", "party": "TDP", "constituency": "Palasa"},
            {"name": "Kinjarapu Atchannaidu", "party": "TDP", "constituency": "Tekkali"},
            {"name": "Mamidi Govinda Rao", "party": "TDP", "constituency": "Pathapatnam"},
            {"name": "Gondu Shankar", "party": "TDP", "constituency": "Srikakulam"},
    ...
    "vizianagaram": {
        "mps": [{"name": "Appalanaidu Kalisetti", "party": "TDP", "constituency": "Vizianagaram"}],
        "mlas": [
            {"name": "Sambangi Venkata China Appala Naidu", "party": "TDP", "constituency": "Bobbili"},
            {"name": "Kimidi Kala Venkata Rao", "party": "TDP", "constituency": "Cheepurupalle"},
    ...
    "visakhapatnam": {
        "mps": [{"name": "Sribharat Mathukumili", "party": "TDP", "constituency": "Visakhapatnam"}],
        "mlas": [
            {"name": "Ganta Srinivasa Rao", "party": "TDP", "constituency": "Bhimli"},
            {"name": "Velagapudi Ramakrishna Babu", "party": "TDP", "constituency": "Visakhapatnam East"},
    ...
    "anakapalli": {
        "mps": [{"name": "C.M. Ramesh", "party": "BJP", "constituency": "Anakapalle"}],
        "mlas": [
            {"name": "Kalidindi Surya Naga Sanyasi Raju", "party": "TDP", "constituency": "Chodavaram"},
            {"name": "Bandaru Satyanarayana Murthy", "party": "TDP", "constituency": "Madugula"},
            {"name": "Konathala Ramakrishna", "party": "JSP", "constituency": "Anakapalle"},
    ...
    "kakinada": {
        "mps": [{"name": "Tangella Uday Srinivas", "party": "JSP", "constituency": "Kakinada"}],
        "mlas": [
            {"name": "Yanamala Divya", "party": "TDP", "constituency": "Tuni"},
            {"name": "Varupula Satya Prabha", "party": "TDP", "constituency": "Prathipadu"},
            {"name": "Pawan Kalyan", "party": "JSP", "constituency": "Pithapuram"},
            {"name": "Pantam Nanaji", "party": "JSP", "constituency": "Kakinada Rural"},
    ...
    "konaseema": {
        "mps": [{"name": "G.M. Harish (Balayogi)", "party": "TDP", "constituency": "Amalapuram (SC)"}],
        "mlas": [
            {"name": "Vasamsetti Subhash", "party": "TDP", "constituency": "Ramachandrapuram"},
            {"name": "Datla Subba Raju", "party": "TDP", "constituency": "Mummidivaram"},
            {"name": "Aithabathula Anandarao", "party": "TDP", "constituency": "Amalapuram (SC)"},
    ...
    "west_godavari": {
        "mps": [{"name": "Bhupathi Raju Srinivasa Varma", "party": "BJP", "constituency": "Narsapuram"}],
        "mlas": [
    ...
    "eluru": {
        "mps": [{"name": "Putta Mahesh Kumar", "party": "TDP", "constituency": "Eluru"}],
        "mlas": [
            {"name": "Patsamatla Dharmaraju", "party": "JSP", "constituency": "Unguturu"},
            {"name": "Chintamaneni Prabhakar", "party": "TDP", "constituency": "Denduluru"},
    ...
    "ntr": {
        "mps": [{"name": "Kesineni Sivanath (Chinni)", "party": "TDP", "constituency": "Vijayawada"}],
        "mlas": [
            {"name": "Kolikapudi Srinivasa Rao", "party": "TDP", "constituency": "Tiruvuru (SC)"},
            {"name": "Sujana Chowdary", "party": "BJP", "constituency": "Vijayawada West"},
            {"name": "Bonda Umamaheswara Rao", "party": "TDP", "constituency": "Vijayawada Central"},
    ...
    "krishna": {
        "mps": [{"name": "Vallabhaneni Balashowry", "party": "JSP", "constituency": "Machilipatnam"}],
        "mlas": [
            {"name": "Kolusu Parthasarathy", "party": "TDP", "constituency": "Nuzvid"},
            {"name": "Yarlagadda Venkata Rao", "party": "TDP", "constituency": "Gannavaram (Krishna)"},
            {"name": "Venigandla Ramu", "party": "TDP", "constituency": "Gudivada"},
            {"name": "Kamineni Srinivas", "party": "BJP", "constituency": "Kaikalur"},
            {"name": "Kagitha Krishna Prasad", "party": "TDP", "constituency": "Pedana"},
    ...
    "guntur": {
        "mps": [{"name": "Dr. Chandra Sekhar Pemmasani", "party": "TDP", "constituency": "Guntur"}],
        "mlas": [
            {"name": "Tenali Sravan Kumar", "party": "TDP", "constituency": "Tadikonda (SC)"},
            {"name": "Nara Lokesh", "party": "TDP", "constituency": "Mangalagiri"},
    ...
    "palnadu": {
        "mps": [{"name": "Lavu Sri Krishna Devarayalu", "party": "TDP", "constituency": "Narasaraopet"}],
        "mlas": [
            {"name": "B. Ramanjaneyulu", "party": "TDP", "constituency": "Prathipadu (SC)"},
            {"name": "Prathipati Pulla Rao", "party": "TDP", "constituency": "Chilakaluripet"},
            {"name": "Chadalavada Aravinda Babu", "party": "TDP", "constituency": "Narasaraopet"},
    ...
    "bapatla": {
        "mps": [{"name": "Krishna Prasad Tenneti", "party": "TDP", "constituency": "Bapatla (SC)"}],
        "mlas": [
            {"name": "Nakka Ananda Babu", "party": "TDP", "constituency": "Vemuru (SC)"},
            {"name": "Anagani Satya Prasad", "party": "TDP", "constituency": "Repalle"},
    ...
    "prakasam": {
        "mps": [{"name": "Magunta Sreenivasulu Reddy", "party": "TDP", "constituency": "Ongole"}],
        "mlas": [
            {"name": "Tatiparthi Chandrasekhar", "party": "YSRCP", "constituency": "Yerragondapalem (SC)"},
            {"name": "Buchepalli Siva Prasad Reddy", "party": "YSRCP", "constituency": "Darsi"},
            {"name": "B.N. Vijay Kumar", "party": "TDP", "constituency": "Santhanuthalapadu (SC)"},
            {"name": "Damacharla Janardhana Rao", "party": "TDP", "constituency": "Ongole"},
    ...
    "nellore": {
        "mps": [{"name": "Vemireddy Prabhakar Reddy", "party": "TDP", "constituency": "Nellore"}],
        "mlas": [
            {"name": "Dagumati Venkata Krishna Reddy", "party": "TDP", "constituency": "Kavali"},
            {"name": "Anam Ramanarayana Reddy", "party": "TDP", "constituency": "Atmakur"},
            {"name": "Vemireddy Prashanthi Reddy", "party": "TDP", "constituency": "Kovur"},
            {"name": "Ponguru Narayana", "party": "TDP", "constituency": "Nellore City"},
    ...
    "kurnool": {
        "mps": [{"name": "Bastipati Nagaraju Panchalingala", "party": "TDP", "constituency": "Kurnool"}],
        "mlas": [
            {"name": "K. E. Shyam Kumar", "party": "TDP", "constituency": "Pattikonda"},
    ...
    "nandyal": {
        "mps": [{"name": "Dr. Byreddy Shabari", "party": "TDP", "constituency": "Nandyal"}],
        "mlas": [
            {"name": "Akhila Priya Bhuma", "party": "TDP", "constituency": "Allagadda"},
            {"name": "Budda Rajasekhara Reddy", "party": "TDP", "constituency": "Srisailam"},
    ...
    "anantapur": {
        "mps": [{"name": "Ambica G. Lakshminarayana", "party": "TDP", "constituency": "Anantapur"}],
        "mlas": [
            {"name": "Kalava Srinivasulu", "party": "TDP", "constituency": "Rayadurg"},
            {"name": "Payyavula Keshav", "party": "TDP", "constituency": "Uravakonda"},
            {"name": "Gummanur Jayaram", "party": "TDP", "constituency": "Guntakal"},
            {"name": "J. C. Ashmit Reddy", "party": "TDP", "constituency": "Tadipatri"},
    ...
    "sathya_sai": {
        "mps": [{"name": "B.K. Parthasarathi", "party": "TDP", "constituency": "Hindupur"}],
        "mlas": [
            {"name": "M. S. Raju", "party": "TDP", "constituency": "Madakasira (SC)"},
            {"name": "Nandamuri Balakrishna", "party": "TDP", "constituency": "Hindupur"},
    ...
    "kadapa": {
        "mps": [{"name": "Y.S. Avinash Reddy", "party": "YSRCP", "constituency": "Kadapa"}],
        "mlas": [
            {"name": "Dasari Sudha", "party": "YSRCP", "constituency": "Badvel (SC)"},
            {"name": "Reddeppagari Madhavi Reddy", "party": "TDP", "constituency": "Kadapa"},
            {"name": "Y. S. Jagan Mohan Reddy", "party": "YSRCP", "constituency": "Pulivendla"},
    ...
    "annamayya": {
        "mps": [{"name": "P.V. Midhun Reddy", "party": "YSRCP", "constituency": "Rajampet"}],
        "mlas": [
            {"name": "Akepati Amarnath Reddy", "party": "YSRCP", "constituency": "Rajampet"},
            {"name": "Arava Sreedhar", "party": "JSP", "constituency": "Kodur (SC)"},
    ...
    "chittoor": {
        "mps": [{"name": "Daggumalla Prasada Rao", "party": "TDP", "constituency": "Chittoor (SC)"}],
        "mlas": [
            {"name": "Peddireddy Ramachandra Reddy", "party": "YSRCP", "constituency": "Punganur"},
            {"name": "Pulivarthi Venkata Mani Prasad (Nani)", "party": "TDP", "constituency": "Chandragiri"},
            {"name": "Gurajala Jagan Mohan", "party": "TDP", "constituency": "Chittoor"},
            {"name": "Kalikiri Murali Mohan", "party": "TDP", "constituency": "Puthalapattu (SC)"},
    ...
    "tirupati": {
        "mps": [{"name": "Maddila Gurumoorthy", "party": "YSRCP", "constituency": "Tirupati (SC)"}],
        "mlas": [
            {"name": "Arani Srinivasulu", "party": "JSP", "constituency": "Tirupati"},
